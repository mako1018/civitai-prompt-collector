...
# -----------------------
def main():
    # デフォルトは Illustrious Realism のみ（model_id=1412827）
    target_models = {
    ...
    # 可視化: モデルごとのカテゴリ分布（割合・%表示）
    collector.visualize_category_distribution(models_to_plot=list(target_models.keys()), normalize_percent=True, show=True)
